...
• Личное ревью ключевых решений
• Помощь в доведении до боевого запуска
• Формат личной работы: чат + созвоны по необходимости
• Доступ к материалам без ограничения по времени`
  ...
  },
  {
    ...
    answer: `Потому что ближе к старту меньше мест и выше плотность личной работы. Я работаю с каждым участником лично, поэтому набор ограничен. Чем раньше ты заходишь — тем выгоднее условия.`
  },
  {
    id: 4,
...
• Тех, кто хочет выйти на запуск и монетизацию`
  ...
  },
  {
    ...
    answer: `Формат — личная работа. Это не групповые вебинары, а индивидуальный трек: ты работаешь над своим проектом, я помогаю с архитектурой, кодом и запуском. Общение в чате + созвоны по необходимости.`
  }
];
